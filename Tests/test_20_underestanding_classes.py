...
def test_classes_are_object_factories():
    ...
    assert 'type' == type(q1).__class__.__name__
    assert 'type' == type(q2).__class__.__name__
    ...
    # assert 35 == len(dir(Queue))
    # assert 20 == len(dir(q1))
    # assert 20 == len(dir(q2))
...
def test_classes_bound_and_unbound_methods():
    ...
    #assert True == Queue.push   #unbound method
    #assert False == q1_push.__self__      #bound method
