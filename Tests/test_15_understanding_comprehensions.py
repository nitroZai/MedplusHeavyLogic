...
# This is a set so duplicates will be remnoved
...
- Compresensions and how they work in basic loop and nested loops
- Comprehensions with DIctionaries
- string library and how to generate ASCII Dummy text
- ord('x'), Uni ASCII Code
- char(ord('A')) -> Gives a character 
"""
